...
#### <a id="h1.5"></a>Hint
Count how many heads can appear in four coin tosses and add probabilities for the distributions where the number of heads is odd.
...
- $E[T] = \left(\frac{101 - T}{100}ight)\left(\frac{T + 100}{2}ight) + \left(\frac{T - 1}{100}ight)(49.5)$. 
...
- First, note that we need at least $\lceil \log_2(10) ceil = 4$ binary digits, since $2^3 = 8$ is too small but $2^4 = 16$ is sufficient. 
...
### <a id="p2.63"></a>Problem 2.62: Windy Pedal Puzzle
